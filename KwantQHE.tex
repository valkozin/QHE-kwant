...
\begin{itemize}
	...
	\item \citet{enknerTunableVacuumfieldControl2025}:
		...
		\item Breakdown of topological protection by cavity vacuum fields in the integer quantum Hall effect
		\item https://journals.aps.org/prb/pdf/10.1103/PhysRevB.104.155307.
\end{itemize}

Statement that teleportation is not possible for large samples.

Explanation of QHE modification of small sample.
...
In Ref.~\cite{yi-thomasIntegerQuantumHall2025} (Das Sarma),
	it is claimed that even a small temperature $k_B T = 0.05 \hbar \omega_c$ destroys QHE if the sample is perfectly clean.
Specifically they mention for disorder strength $\Gamma < k_B T$, that the plateau in terms of the filling factor $\nu$ is zero (see Fig.~8 in their paper).
